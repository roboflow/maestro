...
class Qwen25VLConfiguration:
    ...
    Attributes:
        ...
        early_stopping_threshold (float): Minimum change in monitored quantity to qualify as improvement.
        early_stopping_monitor (str): Quantity to be monitored for early stopping.
    """
