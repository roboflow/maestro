...
from maestro.trainer.models.paligemma_2.core import PaliGemma2Configuration, train as paligemma2_train
...
def train(
    ...
    model_id: Annotated[
        str, 
        typer.Option("--model_id", help="Identifier for the PaliGemma-2 model")
    ] = DEFAULT_PALIGEMMA2_MODEL_ID,
    revision: Annotated[
        str, 
